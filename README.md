...
一个基于 [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) 的 SQL 数据库服务，让 Claude 等 AI 助手能够通过标准 MCP 协议与 MySQL / SQL Server / PostgreSQL / SQLite 数据库进行交互，支持执行 SQL 查询和检索数据库 Schema。
